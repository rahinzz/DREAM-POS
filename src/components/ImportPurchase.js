							...
							<div className="row">
										...
										<div className="row">
											...
											<div className="col-lg-2 col-sm-2 col-2 ps-0">
												<div className="add-icon">
													<Link href="javascript:void(0);"><img src="assets/img/icons/plus1.svg" alt="img" /></Link>
												</div>
											</div>
										</div>
									</div>
								...
								<div className="col-lg-12 col-sm-6 col-12">
									<div className="row">
										<div className="col-lg-3 col-sm-6 col-12">
											<div className="form-group">
												<Link className="btn btn-submit w-100">Download Sample File</Link>
											</div>
										</div>
									</div>
								</div>
								...
								<div className="col-lg-12">
									<Link href="javascript:void(0);" className="btn btn-submit me-2">Submit</Link>
									<Link href="javascript:void(0);"  className="btn btn-cancel">Cancel</Link>
								</div>
							</div>
						</div>
					</div>
