						...
						<div className="col-lg-12">
							...
							<div className="card">
								...
								<div className="card-body">
									<form action="#">
										<div className="form-group row">
											<label className="col-form-label col-lg-2">Left Dropdown Text Addons</label>
											<div className="col-lg-10">
												<div className="input-group">
													...
													<ul className="dropdown-menu">
														<li><Link className="dropdown-item" to="javascript:void(0);">Action</Link></li>
														<li><Link className="dropdown-item" to="javascript:void(0);">Another action</Link></li>
														<li><Link className="dropdown-item" to="javascript:void(0);">Something else here</Link></li>
														<li><hr className="dropdown-divider" /></li>
														<li><Link className="dropdown-item" to="javascript:void(0);">Separated link</Link></li>
													</ul>
										...
										<div className="form-group row mb-0">
											<label className="col-form-label col-lg-2">Right Dropdown Text Addons</label>
											<div className="col-lg-10">
												<div className="input-group">
													<input type="text" className="form-control" aria-label="Text input with dropdown button" />
													<button className="btn btn-outline-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Dropdown</button>
