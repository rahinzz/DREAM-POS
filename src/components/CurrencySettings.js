				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link  className="btn btn-added" data-bs-toggle="modal" data-bs-target="#addpayment"><img src="assets/img/icons/plus.svg" alt="img" className="me-1" />Add New Currency</Link>
						</div>
					</div>
					{/* /product list */}
					<div className="card">
									...
									<tbody>
										<tr>
											...
											<td className="text-end">
												<Link className="me-3" to="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#editpayment">
