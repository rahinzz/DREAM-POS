...
<li className="submenu">
							...
							<li className="submenu">
								...
								<ul>
									<li><a href="generalsettings.html" className="active">General Settings</a></li>
				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<a  className="btn btn-added" data-bs-toggle="modal" data-bs-target="#addpayment"><img src="assets/img/icons/plus.svg" alt="img" className="me-1" />Add New Currency</a>
						</div>
					</div>
					{/* /product list */}
					<div className="card">
									...
									<tbody>
										<tr>
											...
											<td className="text-end">
												<a className="me-3" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#editpayment">
		...
		{/* add Modal */}
		<div className="modal fade" id="addpayment" tabindex="-1" role="dialog"   aria-hidden="true">
			<div className="modal-dialog modal-dialog-centered" role="document">
				<div className="modal-content">
						...
						<div className="row">
							<div className="col-12">
								<div className="form-group">
									<label>Currency Name<span className="manitory">*</span></label>
									<input type="text" />
								</div>
							</div>
							<div className="col-12">
							...
							<div className="col-12">
								<div className="form-group">
									<label>Currency Symbol<span className="manitory">*</span></label>
									<input type="text" />
								</div>
							</div>
							<div className="col-12">
					...
					<div className="modal-footer">
						<button type="button" className="btn btn-submit">Confirm</button>
		...
		{/* edit Modal */}
		<div className="modal fade" id="editpayment" tabindex="-1" role="dialog"   aria-hidden="true">
			<div className="modal-dialog modal-dialog-centered" role="document">
				<div className="modal-content">
					<div className="modal-header">
