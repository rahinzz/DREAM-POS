					...
					<div className="content">
						<div className="page-header">
							...
							<div className="page-btn">
								<a href="createpurchasereturn.html" className="btn btn-added">
									<img src="assets/img/icons/plus.svg" alt="img" className="me-2" />Add Purchase Return
								</a>
							</div>
						</div>
						{/* product list  */}
										...
										<tbody>
											<tr>
												...
												<td>
													...
													<a className="me-3" href="editpurchasereturn.html">
