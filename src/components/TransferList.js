				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link to="/addtransfer" className="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" className="me-2" />Add Transfer</Link>
						</div>
					</div>
								...
								<table className="table  datanew">
									...
									<tbody>
										<tr>
											...
											<td>
												<Link className="me-3" to="edittransfer.html">
										...
										<tr>
											...
											<td><span className="badges bg-lightgreen">Completed</span></td>
											<td>
												<Link className="me-3" to="/edittransfer">
													<img src="assets/img/icons/edit.svg" alt="img" />
												</Link>
												<Link className="me-3 confirm-text" to="javascript:void(0);">
													<img src="assets/img/icons/delete.svg" alt="img" />
