								...
								<div className="card-body">
									<div className="row">
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="donut" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>1/5</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="donut" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>226/360</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="donut" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>0.52/1.561</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="donut" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>1,4</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="donut" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>226,134</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="donut" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>0.52,1.041</span>
											</div>
										</div>
									</div>
								</div>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="row">
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="pie" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>1/5</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="pie" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>226/360</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="pie" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>0.52/1.561</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="pie" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>1,4</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="pie" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>226,134</span>
											</div>
										</div>
										<div className="col-lg-2 col-md-4">
											<div className="card-body ">
												<span className="pie" data-peity='{ "fill": ["#7638ff", "rgba(67, 87, 133, .09)"]}'>0.52,1.041</span>
											</div>
										</div>
									</div>
								</div>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="row">
										<div className="col-lg-4">
											<div className="card-body ">
												<span className="bar" data-peity='{ "fill": ["#5b73e8", "#38cb89"]}'>6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
											</div>
										</div>
										<div className="col-lg-4">
											<div className="card-body ">
												<span className="bar" data-peity='{ "fill": ["#38cb89", "#3e80eb"]}'>6,2,8,4,-3,8,1,-3,6,-5,9,2,-8,1,4,8,9,8,2,1</span>
											</div>
										</div>
										<div className="col-lg-4">
											<div className="card-body ">
												<span className="bar" data-peity='{ "fill": ["#ef4b4b", "#ffab00"]}'>6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
											</div>
										</div>
									</div>
								</div>
