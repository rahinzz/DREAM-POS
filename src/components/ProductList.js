									...
									<tbody>
										<tr>
											...
											<td>
												...
												<Link className="me-3" to="/editproduct">
													<img src="assets/img/icons/edit.svg" alt="img" />
												</Link>
												<Link className="confirm-text" to="javascript:void(0);">
										...
										<tr>
											...
											<td>
												...
												<Link className="me-3" href="/editproduct">
													<img src="assets/img/icons/edit.svg" alt="img" />
												</Link>
												<Link className="confirm-text" to="javascript:void(0);">
													<img src="assets/img/icons/delete.svg" alt="img" />
										...
										<tr>
											...
											<td>Admin</td>
											<td>
												<Link className="me-3" to="/product-detail">
													<img src="assets/img/icons/eye.svg" alt="img" />
												</Link>
												<Link className="me-3" to="/editproduct">
													<img src="assets/img/icons/edit.svg" alt="img" />
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Banana</Link>
											</td>
											<td>PT0010</td>
											<td>Health Care	</td>
											<td>N/D</td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Limon</Link>
											</td>
											<td>PT0011</td>
											<td>Health Care	</td>
											<td>N/D</td>
