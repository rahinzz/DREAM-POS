						...
						<div className="card-body">
								...
								<div className="col-lg-3 col-sm-6 col-12">
									<div className="form-group">
										...
										<div className="input-groupicon">
											<input type="text" value="10-03-2022" className="datetimepicker" />
											...
											<tr className="bor-b1">
												...
												<td>
													<div className="input-group form-group mb-0">
														...
														<input type="text" value="1" className="calc-no" />
														<Link className="scanner-set input-group-text">
												...
												<td>1500.00</td>
												<td>
													<Link to="javascript:void(0);"><img src="assets/img/icons/delete.svg" alt="svg" /></Link>
												</td>
											</tr>
										</tbody>
									</table>
							...
							<div className="row">
								...
								<div className="col-lg-12">
									...
									<Link to="/transferlist"  className="btn btn-cancel">Cancel</Link>
								</div>
							</div>
						</div>
					</div>
