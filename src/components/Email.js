                    ...
                    <div className="row">
						<div className="col-lg-3 col-md-12">
							<div className="compose-btn">
								<Link to="javascript:void(0);" className="btn btn-primary btn-block w-100">
								Compose
								</Link>
							</div>
							<ul className="inbox-menu">
								<li className="active">
									<Link to="javascript:void(0);"><i className="fas fa-download"></i> Inbox <span className="mail-count">(5)</span></Link>
								</li>
								<li>
									<Link to="javascript:void(0);"><i className="far fa-star"></i> Important</Link>
								</li>
								<li>
									<Link to="javascript:void(0);"><i className="far fa-paper-plane"></i> Sent Mail</Link>
								</li>
								<li>
									<Link to="javascript:void(0);"><i className="far fa-file-alt"></i> Drafts <span className="mail-count">(13)</span></Link>
								</li>
								<li>
									<Link to="javascript:void(0);"><i className="far fa-trash-alt"></i> Trash</Link>
								</li>
							</ul>
						</div>
												...
												<div className="float-left">
													<div className="btn-group dropdown-action">
														...
														<div className="dropdown-menu">
															<Link className="dropdown-item" to="javascript:void(0);">All</Link>
															<Link className="dropdown-item" to="javascript:void(0);">None</Link>
															<div className="dropdown-divider"></div> 
															<Link className="dropdown-item" to="javascript:void(0);">Read</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Unread</Link>
														</div>
													</div>
													<div className="btn-group dropdown-action">
														...
														<div className="dropdown-menu">
															<Link className="dropdown-item" to="javascript:void(0);">Reply</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Forward</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Archive</Link>
															<div className="dropdown-divider"></div> 
															<Link className="dropdown-item" to="javascript:void(0);">Mark As Read</Link>
													...
													<div className="btn-group dropdown-action">
														...
														<div role="menu" className="dropdown-menu">
															...
															<Link className="dropdown-item" to="javascript:void(0);">Forums</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Updates</Link>
															<div className="dropdown-divider"></div> 
															<Link className="dropdown-item" to="javascript:void(0);">Spam</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Trash</Link>
															<div className="dropdown-divider"></div> 
															<Link className="dropdown-item" to="javascript:void(0);">New</Link>
														</div>
													</div>
													<div className="btn-group dropdown-action">
														...
														<div role="menu" className="dropdown-menu">
															<Link className="dropdown-item" to="javascript:void(0);">Work</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Family</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Social</Link>
															<div className="dropdown-divider"></div> 
															<Link className="dropdown-item" to="javascript:void(0);">Primary</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Promotions</Link>
															<Link className="dropdown-item" to="javascript:void(0);">Forums</Link>
														</div>
													</div>
											...
											<div className="col-lg-3 top-action-right col-sm-12">
												<div className="text-end">
													...
													<div className="btn-group">
														<Link className="btn btn-white"><i className="fas fa-angle-left"></i></Link>
														<Link className="btn btn-white"><i className="fas fa-angle-right"></i></Link>
													</div>
												</div>
												<div className="text-end">
