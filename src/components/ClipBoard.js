						...
						<div className="col-md-12">	
								...
								<div className="card-body">
									<div className="clipboard">
										<form className="form-horizontal">
											<input type="text" className="form-control mb-4" id="input-copy" value="http://www.admin-dashboard.com" />
											<Link className="mb-1 btn clip-btn btn-primary" to="javascript:;" data-clipboard-action="copy" data-clipboard-target="#input-copy"><i className="far fa-copy"></i> Copy from Input</Link>
											<Link className="mb-1 btn clip-btn btn-dark" to="javascript:;" data-clipboard-action="cut" data-clipboard-target="#input-copy"><i className="fas fa-cut"></i> Cut from Input</Link>
										</form>
									</div>
								</div>
							</div>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="clipboard">
										<form className="form-horizontal">
											<textarea className="form-control mb-4" rows="3" id="textarea-copy">Lorem ipsum dolor sit amet, consectetur adipiscing elit...</textarea>
											<Link className="mb-1 btn clip-btn btn-primary" to="javascript:;" data-clipboard-action="copy" data-clipboard-target="#textarea-copy"><i className="far fa-copy"></i> Copy from Input</Link>
											<Link className="mb-1 btn clip-btn btn-dark" to="javascript:;" data-clipboard-action="cut" data-clipboard-target="#textarea-copy"><i className="fas fa-cut"></i> Cut from Input</Link>
										</form>
									</div>
								</div>
							</div>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="clipboard copy-txt">
										...
										<Link className="mb-1 btn clip-btn btn-primary" to="javascript:;" data-clipboard-action="copy" data-clipboard-target="#paragraph-copy1"><i className="far fa-copy"></i> Copy from Input</Link>
									</div>
								</div>
							</div>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="clipboard copy-txt">
										<p className="mb-4">Link -&gt; <span id="advanced-paragraph">http://www.example.com/example</span></p>
										<Link className="mb-1 btn clip-btn btn-primary" to="javascript:;" data-clipboard-action="copy" data-clipboard-target="#advanced-paragraph"><i className="far fa-copy"></i> Copy Link</Link>
										<Link className="mb-1 btn clip-btn btn-warning" to="javascript:;" data-clipboard-action="copy" data-clipboard-text="2291"><i className="far fa-copy"></i> Copy Hidden Code</Link>
									</div>
								</div>
							</div>
