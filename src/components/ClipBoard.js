								...
								<div className="card-body">
									<div className="clipboard">
										<form className="form-horizontal">
											...
											<a className="mb-1 btn clip-btn btn-primary" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#input-copy"><i className="far fa-copy"></i> Copy from Input</a>
											<a className="mb-1 btn clip-btn btn-dark" href="javascript:;" data-clipboard-action="cut" data-clipboard-target="#input-copy"><i className="fas fa-cut"></i> Cut from Input</a>
										</form>
									</div>
								</div>
							</div>
								...
								<div className="card-body">
									<div className="clipboard">
										<form className="form-horizontal">
											...
											<a className="mb-1 btn clip-btn btn-primary" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#textarea-copy"><i className="far fa-copy"></i> Copy from Input</a>
											<a className="mb-1 btn clip-btn btn-dark" href="javascript:;" data-clipboard-action="cut" data-clipboard-target="#textarea-copy"><i className="fas fa-cut"></i> Cut from Input</a>
										</form>
									</div>
								</div>
							</div>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="clipboard copy-txt">
										...
										<a className="mb-1 btn clip-btn btn-primary" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#paragraph-copy1"><i className="far fa-copy"></i> Copy from Input</a>
									</div>
								</div>
							</div>
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="clipboard copy-txt">
										...
										<a className="mb-1 btn clip-btn btn-primary" href="javascript:;" data-clipboard-action="copy" data-clipboard-target="#advanced-paragraph"><i className="far fa-copy"></i> Copy Link</a>
										<a className="mb-1 btn clip-btn btn-warning" href="javascript:;" data-clipboard-action="copy" data-clipboard-text="2291"><i className="far fa-copy"></i> Copy Hidden Code</a>
									</div>
								</div>
							</div>
