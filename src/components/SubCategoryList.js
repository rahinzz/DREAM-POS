				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link to="/subaddcategory" className="btn btn-added"><img src="assets/img/icons/plus.svg"  className="me-2" alt="img" /> Add Sub Category</Link>
						</div>
					</div>
								...
								<table className="table  datanew">
									...
									<tbody>
										<tr>
											...
											<td>Admin</td>
											<td>
												<Link className="me-3" to="/editsubcategory">
