					...
					<div className="card">
						<div className="card-body">
							<div className="card-sales-split">
								...
								<ul>
									<li>
										<Link to="javascript:void(0);"><img src="assets/img/icons/edit.svg" alt="img" /></Link>
									</li>
									<li>
										<Link to="javascript:void(0);"><img src="assets/img/icons/pdf.svg" alt="img" /></Link>
									</li>
									<li>
										<Link to="javascript:void(0);"><img src="assets/img/icons/excel.svg" alt="img" /></Link>
									</li>
									<li>
										<Link to="javascript:void(0);"><img src="assets/img/icons/printer.svg" alt="img" /></Link>
									</li>
								</ul>
							</div>
							<div className="invoice-box table-height" style="max-width: 1600px;width:100%;overflow: auto;margin:15px auto;padding: 0;font-size: 14px;line-height: 24px;color: #555;">
								<table cellpadding="0" cellspacing="0" style="width: 100%;line-height: inherit;text-align: left;">
											...
											<table style="width: 100%;line-height: inherit;text-align: left;">
												<tbody><tr>
													<td style="padding:5px;vertical-align:top;text-align:left;padding-bottom:20px">
														...
														<font style="vertical-align: inherit;"><font style="vertical-align: inherit;font-size: 14px;color:#000;font-weight: 400;"> walk-in-customer@example.com</font></font><br />
									...
									<tr className="details" style="border-bottom:1px solid #E9ECEF ;">
							...
							<div className="row">
								...
								<div className="col-lg-12">
									<Link to="javascript:void(0);" className="btn btn-submit me-2">Update</Link>
									<Link to="javascript:void(0);" className="btn btn-cancel">Cancel</Link>
								</div>
							</div>
						</div>
					</div>
