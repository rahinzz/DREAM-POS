					...
					<div className="row">
							...
							<div className="card">
								...
								<div className="card-body">
									<div className="popover-list">
										<button className="btn btn-primary mx-1" type="button" data-bs-toggle="popover" title="" data-bs-content="And here's some amazing content. It's very engaging. Right?" data-bs-original-title="Popover title" aria-describedby="popover249009">Click to toggle popover</button>
										
										<Link className="example-popover btn btn-primary mx-1" tabIndex="0" role="button" data-bs-toggle="popover" data-bs-trigger="focus" title="" data-bs-content="And here's some amazing content. It's very engaging. Right?" data-bs-original-title="Popover title">Dismissible popover</Link>
										
										<button className="example-popover btn btn-primary mx-1" type="button" data-bs-trigger="hover" data-container="body" data-bs-toggle="popover" data-bs-placement="bottom" title="" data-offset="-20px -20px" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-original-title="Popover title">On Hover Tooltip</button>
									</div>
								</div>
							</div>
						</div>
						...
						<div className="col-md-12">	
							<div className="card">
								...
								<div className="card-body">
									<div className="popover-list">
										<button className="example-popover btn btn-primary mx-1" type="button" data-container="body" data-bs-toggle="popover" data-bs-placement="top" title="" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-original-title="Popover title">Popover on top</button>
										<button className="example-popover btn btn-primary mx-1" type="button" data-container="body" data-bs-toggle="popover" data-bs-placement="right" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-original-title="" title="">Popover on right</button>
										<button className="example-popover btn btn-primary mx-1" type="button" data-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-original-title="" title="">Popover on bottom</button>
										<button className="example-popover btn btn-primary mx-1" type="button" data-container="body" data-bs-toggle="popover" data-bs-placement="left" data-bs-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus." data-bs-original-title="" title="">Popover on left</button>
									</div>
								</div>
							</div>
						</div>
