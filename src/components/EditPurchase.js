										...
										<div className="row">
											...
											<div className="col-lg-2 col-sm-2 col-2 ps-0">
												<div className="add-icon">
													<Link to="javascript:void(0);"><img src="assets/img/icons/plus1.svg" alt="img" /></Link>
												</div>
											</div>
										</div>
									</div>
									...
									<table className="table">
										...
										<tbody>
											<tr>
												...
												<td className="text-end">2000.00</td>
												<td>
													<Link className="delete-set"><img src="assets/img/icons/delete.svg" alt="svg" /></Link>
												</td>
											</tr>
											<tr>
												<td className="productimgname">
							...
							<div className="row">
								...
								<div className="col-lg-12">
									<div className="form-group">
										...
										<textarea className="form-control">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text</textarea>
									</div>
								</div>
								<div className="col-lg-12">
									<Link to="javascript:void(0);" className="btn btn-submit me-2">Submit</Link>
									<Link to="/purchaselist" className="btn btn-cancel">Cancel</Link>
								</div>
							</div>
						</div>
					</div>
