							...
							<div className="row">
								<div className="col-lg-3 col-sm-6 col-12">
									...
									<div className="form-group">
										...
										<div className="pass-group">
											<input type="password" className=" pass-input" value="123456" />
								...
								<div className="col-lg-3 col-sm-6 col-12">
									...
									<div className="form-group">
										...
										<div className="pass-group">
											<input type="password" className=" pass-inputs" value="123456" />
											<span className="fas toggle-passworda fa-eye-slash"></span>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-sm-6 col-12">
									<div className="form-group uploadedimage">
											...
											<div className="image-uploads">
												...
												<div className="productviews">
													<div className="productviewscontent">
														...
														<Link to="javascript:void(0);" className="hideset">x</Link>
													</div>
												</div>
											</div>
										</div>
