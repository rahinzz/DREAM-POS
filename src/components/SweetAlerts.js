						...
						<div className="col-md-12">
							...
							<div className="card">
								...
								<div className="card-body">
									...
									<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="basic-alert">Basic</button>
									<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="with-title">With Title</button>
									<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="footer-alert">With Footer</button>
								</div>
							</div>
							{/* /Basic Examples  */}
							...
							<div className="card">
								...
								<div className="card-body">
									...
									<button className="btn btn-outline-success mr-1 mb-1" id="position-top-start">Top Start</button>
									<button className="btn btn-outline-success mr-1 mb-1" id="position-top-end">Top End</button>
									<button className="btn btn-outline-success mr-1 mb-1" id="position-bottom-start">Bottom Starts</button>
									<button className="btn btn-outline-success mr-1 mb-1" id="position-bottom-end">Bottom End</button>
								</div>
							</div>
							{/* \Position  */}
							...
							<div className="card">
								...
								<div className="card-body">
									<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="auto-close">Auto Close</button>
									<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="outside-click">Click Outside</button>
									<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="prompt-function">Question</button>
								</div>
							</div>
							{/* \Options  */}
							...
							<div className="card">
								...
								<div className="card-body">
									...
									<button type="button" className="btn btn-outline-primary mb-3" id="confirm-text">Confirm Text</button>
									<h5>Confirm Button Color</h5>
									<p>Use {<code>confirmButtonClass: "btn btn-primary"</code>} option to change the color of the  "Confirm" button.</p>
									<button type="button" className="btn btn-outline-primary mb-2" id="confirm-color">Confirm Button Color</button>
								</div>
							</div>
							{/* \Confirm Options  */}
