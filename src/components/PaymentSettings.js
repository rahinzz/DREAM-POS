				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<a  className="btn btn-added" data-bs-toggle="modal" data-bs-target="#addpayment"><img src="assets/img/icons/plus.svg" alt="img" className="me-2" />Add Payment Settings</a>
						</div>
					</div>
					{/* /product list */}
					<div className="card">
