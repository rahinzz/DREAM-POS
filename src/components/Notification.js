					...
					<div className="row">
						...
						<div className="col-md-4">	
							<div className="card">
								...
								<div className="card-body">
									 <a href="javascript: void(0);"  id="alert-success" className="btn btn-primary btn-sm waves-effect waves-light">Click me</a>
								</div>
							</div>
						</div>
						{/* /Alert */}
						...
						<div className="col-md-4">	 
							<div className="card">
								...
								<div className="card-body">
									 <a href="javascript: void(0);"  id="alert-error" className="btn btn-primary btn-sm waves-effect waves-light">Click me</a>
								</div>
							</div>
						</div>
						{/* /Alert */}
						...
						<div className="col-md-4">	
							<div className="card">
								...
								<div className="card-body">
									 <a href="javascript: void(0);"  id="alert-warning" className="btn btn-primary btn-sm waves-effect waves-light">Click me</a>
								</div>
							</div>
						</div>
						{/* /Alert  */}
