              ...
              <ul>
                ...
                <li className="submenu">
                  ...
                  <ul>
                    ...
                    <li>
                      v<Link to="/currencysettings">Currency Settings</Link>
                    </li>
                    <li>
				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link to="/addcategory" className="btn btn-added">
									...
									<tbody>
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Computers</Link>
											</td>
											<td>CT001</td>
											<td>Computers Description</td>
											<td>Admin</td>
											<td>
												<Link className="me-3" href="/editcategory">
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Fruits</Link>
											</td>
											<td>CT002</td>
											<td>Fruits Description</td>
											<td>Admin</td>
											<td>
												<Link className="me-3" to="/editcategory">
													<img src="assets/img/icons/edit.svg" alt="img" />
												</Link>
												<Link className="me-3 confirm-text" to="javascript:void(0);">
													<img src="assets/img/icons/delete.svg" alt="img" />
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Accessories</Link>
											</td>
											<td>CT005</td>
