				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link to="/adduser" className="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" className="me-2" />Add User</Link>
						</div>
					</div>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<Link className="me-3" to="/edituser">
										...
										<tr>
											...
											<td>
												<div className="status-toggle d-flex justify-content-between align-items-center">
													...
													<label htmlhtmlFor="user5" className="checktoggle">checkbox</label>
												</div>
											</td>
											<td>
										...
										<tr>
											...
											<td>
												<div className="status-toggle d-flex justify-content-between align-items-center">
													<input type="checkbox" id="user19" className="check" checked />
													<label htmlFor="user19" className="checktoggle">checkbox</label>
												</div>
											</td>
											<td>
										...
										<tr>
											...
											<td>
												<div className="status-toggle d-flex justify-content-between align-items-center">
													<input type="checkbox" id="user18" className="check" checked />
													<label htmlFor="user18" className="checktoggle">checkbox</label>
												</div>
											</td>
											<td>
