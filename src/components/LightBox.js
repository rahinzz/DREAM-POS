								...
								<div className="card-body">
									<div className="row">
										<div className="col-md-4 mb-2 mb-md-0">
											<Link to="assets/img/img-01.jpg" className="image-popup">
												<img src="assets/img/img-01.jpg" className="img-fluid" alt="image" />
											</Link>
										</div>
										<div className="col-md-4 mb-2 mb-md-0">
											<Link to="assets/img/img-02.jpg" className="image-popup">
												<img src="assets/img/img-02.jpg" className="img-fluid" alt="image" />
											</Link>
										</div>
									</div>
								</div>
						...
						<div className="col-md-12">	
							<div className="card">
								...
								<div className="card-body">
									<div className="row">
										<div className="col-md-4 mb-2 mb-md-0">
											<Link to="assets/img/img-03.jpg" className="image-popup-desc" data-title="Title 01" data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit">
												<img src="assets/img/img-03.jpg" className="img-fluid" alt="work-thumbnail" />
											</Link>
										</div>
										<div className="col-md-4 mb-2 mb-md-0">
											<Link to="assets/img/img-04.jpg" className="image-popup-desc" data-title="Title 02" data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit">
												<img src="assets/img/img-04.jpg" className="img-fluid" alt="work-thumbnail" />
											</Link>
										</div>
										<div className="col-md-4 mb-2 mb-md-0">
											<Link to="assets/img/img-05.jpg" className="image-popup-desc" data-title="Title 03" data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit">
												<img src="assets/img/img-05.jpg" className="img-fluid" alt="work-thumbnail" />
											</Link>
										</div>
									</div>
								</div>
