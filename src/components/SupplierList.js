				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link to="/addsupplier" className="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" />Add Supplier</Link>
						</div>
					</div>
									...
									<tbody>
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Apex Computers</Link>
											</td>
											<td>201</td>
											<td>+12163547758 </td>
											...
											<td>
												...
												<Link className="me-3" to="editsupplier.html">
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Modern Automobile</Link>
											</td>
											<td>202</td>
											<td>123-456-888</td>
											...
											<td>
												...
												<Link className="me-3" to="/editsupplier">
													<img src="assets/img/icons/edit.svg" alt="img" />
												</Link>
												<Link className="me-3 confirm-text" to="javascript:void(0);">
													<img src="assets/img/icons/delete.svg" alt="img" />
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">AIM Infotech</Link>
											</td>
											<td>521</td>
											<td>123-456-888</td>
											<td>customer@example.com</td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Best Power Tools</Link>
											</td>
											<td>555</td>
											<td>123-456-888</td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Vinayak Tools</Link>
											</td>
											<td>681</td>
											<td>123-456-888</td>
