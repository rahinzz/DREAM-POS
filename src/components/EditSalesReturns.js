					...
					<div className="card">
						<div className="card-body">
								...
								<div className="col-lg-3 col-sm-6 col-12">
									<div className="form-group">
										...
										<div className="input-groupicon">
											<input type="text" placeholder="2/27/2022" className="datetimepicker" />
							...
							<div className="row">
								...
								<div className="col-lg-12">
									<Link className="btn btn-submit me-2">Update</Link>
									<Link to="/salesreturnlist" className="btn btn-cancel">Cancel</Link>
								</div>
							</div>
						</div>
					</div>
