                                        ...
                                        <div className="tab-content twitter-bs-wizard-tab-content">
                                            <div className="tab-pane" id="seller-details">
                                                ...
                                                <ul className="pager wizard twitter-bs-wizard-pager-link">
                                                    <li className="next"><a href="javascript: void(0);" className="btn btn-primary" onclick="nextTab()">Next <i
                                                    className="bx bx-chevron-right ms-1"></i></a></li>
                                                </ul>
                                            </div>
                                            {/* tab pane  */}
                                            <div className="tab-pane" id="company-document">
                                              <div>
                                                ...
                                                <ul className="pager wizard twitter-bs-wizard-pager-link">
                                                    <li className="previous"><a href="javascript: void(0);" className="btn btn-primary" onclick="nextTab()"><i
													className="bx bx-chevron-left me-1"></i> Previous</a></li>
                                                    <li className="next"><a href="javascript: void(0);" className="btn btn-primary" onclick="nextTab()">Next <i
                                                    className="bx bx-chevron-right ms-1"></i></a></li>
                                                </ul>
												</div>
                                            ...
                                            <div className="tab-pane" id="bank-detail">
                                                <div>
                                                    ...
                                                    <ul className="pager wizard twitter-bs-wizard-pager-link">
                                                        <li className="previous"><a href="javascript: void(0);" className="btn btn-primary" onclick="nextTab()"><i
                                                                    className="bx bx-chevron-left me-1"></i> Previous</a></li>
                                                        <li className="float-end"><a href="javascript: void(0);" className="btn btn-primary" data-bs-toggle="modal"
                                ...
                                <div className="card-body">
                                    ...
                                    <div id="progrss-wizard" className="twitter-bs-wizard">
                                        <ul className="twitter-bs-wizard-nav nav nav-pills nav-justified">
                                            <li className="nav-item">
                                                <a href="#progress-seller-details" className="nav-link" data-toggle="tab">
                                            ...
                                            <li className="nav-item">
                                                <a href="#progress-company-document" className="nav-link" data-toggle="tab">
                                            ...
                                            <li className="nav-item">
                                                <a href="#progress-bank-detail" className="nav-link" data-toggle="tab">
