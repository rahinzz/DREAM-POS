                                ...
                                <div className="card-body">
                                    <div id="basic-pills-wizard" className="twitter-bs-wizard">
                                        <ul className="twitter-bs-wizard-nav">
                                            <li className="nav-item">
                                                <Link to="#seller-details" className="nav-link" data-toggle="tab">
                                            ...
                                            <li className="nav-item">
                                                <Link to="#company-document" className="nav-link" data-toggle="tab">
                                            ...
                                            <li className="nav-item">
                                                <Link to="#bank-detail" className="nav-link" data-toggle="tab">
                                        ...
                                        <div className="tab-content twitter-bs-wizard-tab-content">
                                            <div className="tab-pane" id="seller-details">
                                                ...
                                                <ul className="pager wizard twitter-bs-wizard-pager-link">
                                                    <li className="next"><Link to="javascript: void(0);" className="btn btn-primary" onclick="nextTab()">Next <i
                                                    className="bx bx-chevron-right ms-1"></i></Link></li>
                                                </ul>
                                            </div>
                                            {/* tab pane  */}
                                              ...
                                              <div>
                                                ...
                                                <form>
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="basicpill-pancard-input" className="form-label">Address 1</label>
                                                        ...
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="basicpill-vatno-input" className="form-label">Address 2</label>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="basicpill-cstno-input" className="form-label">Landmark</label>
                                                        ...
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="basicpill-servicetax-input" className="form-label">Town</label>
                                                ...
                                                <ul className="pager wizard twitter-bs-wizard-pager-link">
                                                    <li className="previous"><Link to="javascript: void(0);" className="btn btn-primary" onclick="nextTab()"><i
													className="bx bx-chevron-left me-1"></i> Previous</Link></li>
                                                    <li className="next"><Link to="javascript: void(0);" className="btn btn-primary" onclick="nextTab()">Next <i
                                                    className="bx bx-chevron-right ms-1"></i></Link></li>
                                                </ul>
												</div>
                                            ...
                                            <div className="tab-pane" id="bank-detail">
                                                <div>
                                                    ...
                                                    <ul className="pager wizard twitter-bs-wizard-pager-link">
                                                        <li className="previous"><Link to="javascript: void(0);" className="btn btn-primary" onclick="nextTab()"><i
                                                                    className="bx bx-chevron-left me-1"></i> Previous</Link></li>
                                                        <li className="float-end"><Link to="javascript: void(0);" className="btn btn-primary" data-bs-toggle="modal"
                                ...
                                <div className="card-body">
                                    ...
                                    <div id="progrss-wizard" className="twitter-bs-wizard">
                                        <ul className="twitter-bs-wizard-nav nav nav-pills nav-justified">
                                            <li className="nav-item">
                                                <Link to="#progress-seller-details" className="nav-link" data-toggle="tab">
                                                    <div className="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="User Details">
                                                        <i className="far fa-user"></i>
                                                    </div>
                                                </Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link to="#progress-company-document" className="nav-link" data-toggle="tab">
                                                    <div className="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Address Detail">
                                                        <i className="fas fa-map-pin"></i>
                                                    </div>
                                                </Link>
                                            </li>
                                            ...
                                            <li className="nav-item">
                                                <Link to="#progress-bank-detail" className="nav-link" data-toggle="tab">
                                                    <div className="step-icon" data-bs-toggle="tooltip" data-bs-placement="top" title="Payment Details">
                                                        <i className="fas fa-credit-card"></i>
                                                    </div>
                                                </Link>
                                            </li>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                ...
                                                                <input type="text" className="form-control" id="progresspill-firstname-input" />
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="progresspill-lastname-input">Last name</label>
                                                                <input type="text" className="form-control" id="progresspill-lastname-input" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                ...
                                                                <input type="text" className="form-control" id="progresspill-phoneno-input" />
                                                            </div>
                                                        </div>
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="progresspill-email-input">Email</label>
                                                                <input type="email" className="form-control" id="progresspill-email-input" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                            ...
                                            <div className="tab-pane" id="progress-company-document">
                                                ...
                                                <form>
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="progresspill-pancard-input" className="form-label">Address Line 1</label>
                                                                <input type="text" className="form-control" id="progresspill-pancard-input" />
                                                            </div>
                                                        </div>

                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="progresspill-vatno-input" className="form-label">Address Line 2</label>
                                                                <input type="text" className="form-control" id="progresspill-vatno-input" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="progresspill-cstno-input" className="form-label">Landmark</label>
                                                                <input type="text" className="form-control" id="progresspill-cstno-input" />
                                                            </div>
                                                        </div>

                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="progresspill-servicetax-input" className="form-label">City</label>
                                                                <input type="text" className="form-control" id="progresspill-servicetax-input" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="row">
                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="progresspill-companyuin-input" className="form-label">State</label>
                                                                <input type="text" className="form-control" id="progresspill-companyuin-input" />
                                                            </div>
                                                        </div>

                                                        <div className="col-lg-6">
                                                            <div className="mb-3">
                                                                <label htmlFor="progresspill-declaration-input" className="form-label">Country</label>
                                                                <input type="text" className="form-control" id="progresspill-declaration-input" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
                                            ...
                                            <div className="tab-pane" id="progress-bank-detail">
                                                <div>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-lg-6">
                                                                <div className="mb-3">
                                                                    ...
                                                                    <input type="text" className="form-control" id="progresspill-namecard-input" />
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-lg-6">
                                                                <div className="mb-3">
                                                                    ...
                                                                    <input type="text" className="form-control" id="progresspill-cardno-input" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="col-lg-6">
                                                                <div className="mb-3">
                                                                    ...
                                                                    <input type="text" className="form-control" id="progresspill-card-verification-input" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="row">
                                                            <div className="col-lg-6">
                                                                <div className="mb-3">
                                                                    ...
                                                                    <input type="text" className="form-control" id="progresspill-expiration-input" />
                                                                </div>
                                                            </div>  
                                                        </div>
                                                    </form>
                                                    <ul className="pager wizard twitter-bs-wizard-pager-link">
                                                        ...
                                                        className="bx bx-chevron-left me-1"></i> Previous</Link></li>
                                                        <li className="float-end"><Link to="javascript: void(0);" className="btn btn-primary" data-bs-toggle="modal"
                                                        data-bs-target=".confirmModal">Save Changes</Link></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
