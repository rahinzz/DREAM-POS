					...
					<div className="content">
						<div className="page-header">
							...
							<div className="page-btn">
								<Link to="/createsalesreturn" className="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" className="me-2" />Add New Sales Return</Link>
							</div>
						</div>
										...
										<tbody>
											<tr>
												...
												<td className="productimgname">
													<Link to="javascript:void(0);" className="product-img">
												...
												<td>
													<Link className="me-3" to=" editsalesreturns.html">
											...
											<tr>
												...
												<td className="productimgname">
													...
													<Link to="javascript:void(0);">Orange</Link>
												</td>
												<td>19 Nov 2022</td>
												<td>Benjamin</td>
												...
												<td>120</td>
												<td>550</td>
												<td><span className="badges bg-lightred">Unpaid</span></td>
												<td>
											...
											<tr>
												...
												<td className="productimgname">
													...
													<Link to="javascript:void(0);">Pineapple</Link>
												</td>
												<td>19 Nov 2022</td>
												<td>James</td>
												<td><span className="badges bg-lightred">Pending</span></td>
												...
												<td>
													...
													<Link className="me-3" to="/editsalesreturns">
														<img src="assets/img/icons/edit.svg" alt="img" />
													</Link>
													<Link className="me-3 confirm-text" to="javascript:void(0);">
														<img src="assets/img/icons/delete.svg" alt="img" />
											...
											<tr>
												...
												<td className="productimgname">
													...
													<Link to="javascript:void(0);">Strawberry</Link>
												</td>
												<td>19 Nov 2022</td>
												<td>Bruklin</td>
												<td><span className="badges bg-lightgreen">Received</span></td>
											...
											<tr>
												...
												<td className="productimgname">
													...
													<Link to="javascript:void(0);">Avocat</Link>
												</td>
												<td>19 Nov 2022</td>
												<td>Beverly</td>
												<td><span className="badges bg-lightred">Pending</span></td>
											...
											<tr>
												...
												<td><span className="badges bg-lightyellow">Ordered</span></td>
												<td>1000</td>
												<td>500</td>
												<td>1000</td>
												<td><span className="badges bg-lightyellow">Partial</span></td>
												<td>
											...
											<tr>
												...
												<td>19 Nov 2022</td>
												<td>Benjamin</td>
												<td><span className="badges bg-lightyellow">Pending</span></td>
												<td>550</td>
												<td>120</td>
												<td>550</td>
												<td><span className="badges bg-lightyellow">Partial</span></td>
...
export default SalesReturnLists