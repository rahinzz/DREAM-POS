				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link  className="btn btn-added" to="/createpermission" ><img src="assets/img/icons/plus.svg" alt="img" className="me-1" />Add Group Permission</Link>
						</div>
					</div>
					{/* /product list */}
					<div className="card">
									...
									<tbody>
										<tr>
											...
											<td className="text-end">
												<Link className="me-3" to="/editpermission">
