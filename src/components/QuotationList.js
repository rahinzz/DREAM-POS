				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link to="/addquotation" className="btn btn-added">
								<img src="assets/img/icons/plus.svg" alt="img" className="me-2" /> Add Quotation
							</Link>
						</div>
					</div>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<Link className="me-3" to="/editquotation">
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Stawberry</Link>
											</td>
											<td>PT003</td>
											<td>walk-in-customer</td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">iPhone 11	</Link>
											</td>
											<td>PT007</td>
											<td>Thomas</td>
											<td><span className="badges bg-lightgreen">Sent</span></td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">samsung	</Link>
											</td>
											<td>PT008</td>
											<td>Benjamin</td>
											<td><span className="badges bg-lightgreen">Ordered</span></td>
											<td>550</td>
											<td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Unpaired gray</Link>
											</td>
											<td>PT0010</td>
											<td>James</td>
											<td><span className="badges bg-lightred">Pending</span></td>
