                    ...
                    <div className="page-header">
						<div className="row align-items-center w-100">
							...
							<div className="col-lg-2 col-sm-12">
								<a href="javascript:void(0);" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_event">Create Event</a>
							</div>
						</div>
					</div>
                    <div className="row">
						<div className="col-lg-3 col-md-4">
							...
							<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_new_event" className="btn mb-3 btn-primary btn-block w-100">
