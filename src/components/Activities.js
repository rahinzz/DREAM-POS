							...
							<ul className="activity-list">
								<li> 
									<div className="activity-user">
										<Link to="/profile" title="" data-toggle="tooltip"  data-original-title="Lesley Grauer">
											<img alt="Lesley Grauer" src="assets/img/customer/profile3.jpg" className=" img-fluid" />
										</Link>
									</div>
									<div className="activity-content">
										<div className="timeline-content">
											<Link to="/profile" className="name">Elwis Mathew </Link> added a new product <Link to="javascript:void(0);">Redmi Pro 7 Mobile</Link>
								...
								<li>
									<div className="activity-user">
										<Link to="/profile" title="" data-toggle="tooltip"   data-original-title="Lesley Grauer">
											<img alt="Lesley Grauer" src="assets/img/customer/profile4.jpg" className=" img-fluid" />
										</Link>
									</div>
									<div className="activity-content">
										<div className="timeline-content">
											<Link to="/profile" className="name">Elizabeth Olsen</Link> added a new product category <Link to="javascript:void(0);">Desktop Computers</Link>
								...
								<li>
									<div className="activity-user">
										<Link to="/profile" title="" data-toggle="tooltip"   data-original-title="Lesley Grauer">
											<img alt="Lesley Grauer" src="assets/img/customer/profile5.jpg" className=" img-fluid" />
										</Link>
									</div>
									<div className="activity-content">
										<div className="timeline-content">
											<div className="timeline-content">
												<Link to="/profile" className="name">William Smith</Link> added a new sales list for<Link to="javascript:void(0);">January Month</Link>
								...
								<li>
									<div className="activity-user">
										<Link to="/profile" title="" data-toggle="tooltip"   data-original-title="Lesley Grauer">
											<img alt="Lesley Grauer" src="assets/img/customer/customer4.jpg" className=" img-fluid" />
										</Link>
									</div>
									<div className="activity-content">
											<div className="timeline-content">
												<Link to="/profile" className="name">Lesley Grauer</Link> has updated invoice <Link to="javascript:void(0);">#987654</Link>
												<span className="time">4 mins ago</span>
											</div>
									</div>
								</li>
