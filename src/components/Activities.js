						...
						<div className="activity-box">
							<ul className="activity-list">
								<li> 
									...
									<div className="activity-content">
										<div className="timeline-content">
											<a href="profile.html" className="name">Elwis Mathew </a> added a new product <a href="javascript:void(0);">Redmi Pro 7 Mobile</a>
								...
								<li>
									...
									<div className="activity-content">
										<div className="timeline-content">
											<a href="profile.html" className="name">Elizabeth Olsen</a> added a new product category <a href="javascript:void(0);">Desktop Computers</a>
								...
								<li>
									...
									<div className="activity-content">
										<div className="timeline-content">
											<div className="timeline-content">
												<a href="profile.html" className="name">William Smith</a> added a new sales list for<a href="javascript:void(0);">January Month</a>
								...
								<li>
									...
									<div className="activity-content">
											<div className="timeline-content">
												<a href="profile.html" className="name">Lesley Grauer</a> has updated invoice <a href="javascript:void(0);">#987654</a>
												<span className="time">4 mins ago</span>
											</div>
									</div>
								</li>
