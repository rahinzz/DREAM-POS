					...
					<div className="row">
						...
						<div className="col-md-4 col-sm-6">	
							<div className="ribbon-vertical-left-wrapper card">
								<div className="card-body">
									<div className="ribbon ribbon-primary ribbon-vertical-left"><i className="fas fa-gift"></i></div>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						</div>
						...
						<div className="col-md-4 col-sm-6">	
							<div className="ribbon-vertical-left-wrapper card">
								<div className="card-body">
									<div className="ribbon ribbon-secondary  ribbon-vertical-left"><i className="fas fa-gift"></i></div>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						</div>
						...
						<div className="col-md-4 col-sm-6">	
							<div className="ribbon-vertical-left-wrapper card">
								<div className="card-body">
									<div className="ribbon ribbon-success ribbon-vertical-left"><i className="fas fa-gift"></i></div>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						</div>
						...
						<div className="col-md-4 col-sm-6">	
							<div className="ribbon-vertical-right-wrapper card">
								<div className="card-body">
									<div className="ribbon ribbon-primary ribbon-vertical-right"><i className="fas fa-gift"></i></div>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						</div>
						...
						<div className="col-md-4 col-sm-6">	
							<div className="ribbon-vertical-right-wrapper card">
								<div className="card-body">
									<div className="ribbon ribbon-secondary  ribbon-vertical-right"><i className="fas fa-gift"></i></div>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						</div>
						...
						<div className="col-md-4 col-sm-6">	
							<div className="ribbon-vertical-right-wrapper card">
								<div className="card-body">
									<div className="ribbon ribbon-success ribbon-vertical-right"><i className="fas fa-gift"></i></div>
									<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text. Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
								</div>
							</div>
						</div>
