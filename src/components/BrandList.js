					...
					<div className="content">
						<div className="page-header">
							...
							<div className="page-btn">
								<Link to="/addbrand" className="btn btn-added"><img src="assets/img/icons/plus.svg"  className="me-2" alt="img" />Add Brand</Link>
							</div>
						</div>
									...
									<table className="table datanew">
										...
										<tbody>
											<tr>
												...
												<td>
													<Link className="me-3" href="editbrand.html">
											...
											<tr>
												...
												<td>
													<Link className="me-3" to="/editbrand">
														<img src="assets/img/icons/edit.svg" alt="img" />
													</Link>
													<Link className="me-3 confirm-text" to="javascript:void(0);">
														<img src="assets/img/icons/delete.svg" alt="img" />
