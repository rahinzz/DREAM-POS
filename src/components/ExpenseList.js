				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link to="/createexpense" className="btn btn-added"><img src="assets/img/icons/plus.svg" className="me-2" alt="img" />Add New Expense</Link>
						</div>
					</div>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<Link className="me-3" to="/editexpense">
										...
										<tr>
											...
											<td>PT003</td>
											<td>19 Nov 2022</td>
											<td><span className="badges bg-lightred">In Active</span></td>
											<td>120</td>
