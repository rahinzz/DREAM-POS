						...
						<div className="col-sm-12"> 
							<div className="card" id="types">
								...
								<div className="card-body">
									<button type="button" className="btn btn-outline-success mr-1 mb-1" id="type-success">Success</button>
									<button type="button" className="btn btn-outline-info mr-1 mb-1" id="type-info">Info</button>
									<button type="button" className="btn btn-outline-warning mr-1 mb-1" id="type-warning">Warning</button>
									<button type="button" className="btn btn-outline-danger mr-1 mb-1" id="type-error">Error</button>
								</div>
							 </div>
						</div>
					</div>
								...
								<div className="card-body">
									<div className="row">
										<div className="col-sm-12 mb-4">
											...
											<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="position-top-left">Top
											Left</button>
											<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="position-top-center">Top
											Center</button>
											<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="position-top-right">Top
											Right</button>
											<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="position-top-full">Top Full
											Width</button>
										</div>

										<div className="col-sm-12">
											<h5 className="mb-3">Bottom Positions</h5>
											<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="position-bottom-left">Bottom
											Left</button>
											<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="position-bottom-center">Bottom
											Center</button>
											<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="position-bottom-right">Bottom
											Right</button>
											<button type="button" className="btn btn-outline-primary mr-1 mb-1" id="position-bottom-full">Bottom
											Full Width</button>
										</div>
									</div>
								</div>
					...
					<div className="row">
						<div className="col-sm-12">
							<div className="card">
								...
								<div className="card-body">
									<button type="button" className="btn btn-outline-success mr-1 mb-1" id="text-notification">Notifications</button>
									<button type="button" className="btn btn-outline-success mr-1 mb-1" id="close-button">Close Button</button>
									<button type="button" className="btn btn-outline-success mr-1 mb-1" id="progress-bar">Progress Bar</button>
									<button type="button" className="btn btn-outline-success mr-1 mb-1" id="clear-toast-btn">Clear Toast</button>
								</div>
							 </div>
						</div>
					</div>
								...
								<div className="card-body">
									<div className="row mt-1">
										<div className="col-md-6 col-sm-12 mb-3 mb-md-0">
											...
											<button type="button" className="btn btn-outline-info mr-1 mb-1" id="show-remove-toast">Show
											Toast</button>
											<button type="button" className="btn btn-outline-danger mr-1 mb-1" id="remove-toast">Remove
											Toast</button>
										</div>
										<div className="col-md-6 col-sm-12 mb-3 mb-md-0">
											<h5>Clear</h5>
											<p>Remove current toasts using animation.</p>
											<button type="button" className="btn btn-outline-info mr-1 mb-1" id="show-clear-toast">Show
											Toast</button>
											<button type="button" className="btn btn-outline-danger mr-1 mb-1" id="clear-toast">Clear
											Toast</button>
										</div>
									</div>
								</div>
						...
						<div className="col-sm-12">
							<div className="card">
								...
								<div className="card-body">
									...
									<button type="button" className="btn btn-outline-info mr-1 mb-1" id="fast-duration">Show .5s</button>
									<button type="button" className="btn btn-outline-info mr-1 mb-1" id="slow-duration">Hide 3s</button>
									<button type="button" className="btn btn-outline-info mr-1 mb-1" id="timeout">Timeout 5s</button>
									<button type="button" className="btn btn-outline-info mr-1 mb-1" id="sticky">Sticky Toast</button>
								</div>
							</div>
						</div>
					</div>					
