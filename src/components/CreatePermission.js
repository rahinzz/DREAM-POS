							...
							<div className="row">
								...
								<div className="col-12 mb-3">
									<div className="input-checkset">
										<ul>
											<li>
												<label className="inputcheck">Select All
										...
										<ul>
											<li>
												...
												<div className="input-checkset">
													<ul>
														<li>
															<label className="inputcheck">View
																<input type="checkbox" />
																<span className="checkmark"></span>
															</label>
														</li>
														<li>
															<label className="inputcheck">Create
																<input type="checkbox" />
																<span className="checkmark"></span>
															</label>
														</li>
														<li>
															<label className="inputcheck">Edit
																<input type="checkbox" />
																<span className="checkmark"></span>
															</label>
														</li>
														<li>
															<label className="inputcheck">Delete
																<input type="checkbox" />
																<span className="checkmark"></span>
															</label>
														</li>
														<li>
															<label className="inputcheck">View all records of all users
																<input type="checkbox" />
																<span className="checkmark"></span>
															</label>
														</li>
											...
											<li>
												...
												<div className="input-checkset">
													<ul>
														...
														<li>
															<label className="inputcheck">Barcode
																<input type="checkbox" />
																<span className="checkmark"></span>
															</label>
														</li>
														<li>
															<label className="inputcheck">Import Products
																<input type="checkbox" />
																<span className="checkmark"></span>
															</label>
														</li>
