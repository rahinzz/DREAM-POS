				...
				<div className="content">
					<div className="page-header">
						...
						<div className="page-btn">
							<Link to="/addcustomer" className="btn btn-added"><img src="assets/img/icons/plus.svg" alt="img" />Add Customer</Link>
						</div>
					</div>
					{/* product list  */}
					<div className="card">
									...
									<tbody>
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Thomas</Link>
											</td>
											<td>201</td>
											<td>Thomas</td>
											<td>+12163547758 </td>
											...
											<td>
												...
												<Link className="me-3" to="/editcustomer">
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Benjamin</Link>
											</td>
											<td>202</td>
											<td>Benjamin</td>
											<td>123-456-888</td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">James</Link>
											</td>
											<td>521</td>
											<td>James</td>
											<td>123-456-888</td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Bruklin</Link>
											</td>
											<td>555</td>
											<td>Bruklin</td>
											<td>123-456-888</td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">Beverly</Link>
											</td>
											<td>325</td>
											<td>Beverly</td>
											<td>+12163547758 </td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">B. Huber</Link>
											</td>
											<td>589</td>
											<td>B. Huber	</td>
											<td>123-456-888</td>
										...
										<tr>
											...
											<td className="productimgname">
												...
												<Link to="javascript:void(0);">James Stawberry</Link>
											</td>
											<td>254</td>
										...
										<tr>
											...
											<td className="productimgname">
												<Link to="javascript:void(0);" className="product-imgs">
													WC
												</Link>
												<Link to="javascript:void(0);">James Stawberry</Link>
											</td>
